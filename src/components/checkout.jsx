...
function Checkout(props) {
  ...
  const handleSubmit = () => {
    const fields = [customerName, customerAddress, cashierName]
    ...
    .then((response) => {
      ...
      setShowSuccess(true)
      setProductsAddedToCart([])
      // open new tab for printing if printReceipt
      if (printReceipt) {
        ...
        <Modal.Body>
          ...
          <div>
            <Form>
              ...
              <Form.Group className="mb-3" controlId="cashierName">
              ...
              <Form.Group>
                <Form.Check
                  ...
                  defaultChecked={true}
                  onChange={() => setPrintReceipt((p) => !p)}
                  type="switch"
                  id="print-receipt"
                  label="Do you want to print the receipt?"
                />
              </Form.Group>
            </Form>
          </div>
